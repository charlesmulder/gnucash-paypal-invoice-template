...
(define-module (gnucash report paypal_taxinvoice))
...
(define (report-renderer report-obj)
  ...
  (let* ((document                  (gnc:make-html-document))
    ...
    (gnc:debug "paypal_taxinvoice.scm: css? is " css?)
    (gnc:debug "paypal_taxinvoice.scm: defined is " (defined? 'gnc-html-engine-supports-css))
    (gnc:debug "paypal_taxinvoice.scm - generated html:") (gnc:debug html)
...
(gnc:define-report
  'version 1
  'name (N_ "PayPal Tax Invoice")
  'report-guid "ffaaf1faa7c84853b72e8d544f2f532a"
  'menu-name (N_ "PayPal Tax Invoice")
